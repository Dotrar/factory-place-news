defmodule FactoryplaceWeb.Router do
  ...
  import FactoryplaceWeb.UserAuth
  import Redirect
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {FactoryplaceWeb.Layouts, :root}
  ...
  if Application.compile_env(:factoryplace, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: FactoryplaceWeb.Telemetry
  ...
  scope "/", FactoryplaceWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{FactoryplaceWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", FactoryplaceWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{FactoryplaceWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", FactoryplaceWeb do
    ...
    live_session :current_user,
      on_mount: [{FactoryplaceWeb.UserAuth, :mount_current_user}] do
